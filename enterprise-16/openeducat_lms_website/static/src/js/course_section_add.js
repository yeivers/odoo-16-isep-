odoo.define('openeducat_lms_website.section.add', function (require) {
'use strict';
...
var CategoryAddDialog = Dialog.extend({
    ...
    _onClickFormSubmit: function (ev) {
        var $form = this.$('#course_section_add_form');
...
publicWidget.registry.websiteSlidesCategoryAdd = publicWidget.Widget.extend({
    ...
    xmlDependencies: ['/openeducat_lms_website/static/src/xml/course_section.xml'],
    events: {

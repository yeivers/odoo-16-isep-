...
var DEFAULT_URL =  "/openeducat_digital_library/demo/files/A_New_Visitor_compressed.pdf";
...
PDFJS.workerSrc = '/openeducat_digital_library/static/lib/pdf-flipbook/pdfjs/pdf_js/pdf.worker.js';
PDFJS.cMapUrl = '/openeducat_digital_library/static/lib/pdf-flipbook/pdfjs/cmaps/';
...
function webViewerInitialized() {
  ...
  var url = $('#pdf_base_data').data('material');
  var file = "data:application/pdf;base64," + url;
...
//  document.getElementById('ExitPresentationMode').addEventListener('click',
//      HandTool.exitPresentationMode.bind(HandTool));
...
// fixme ==> Removed Download Function
